# THIS IS A COPIED FILE FROM THE Mavis/tac_plus PROJECT.  It is only used for unit testing on systems where tac_plus is not installed
# You shoould not be using this file.  Your version should come from the mavis/tac_plus binaries.  This file might be out of date.
...
BEGIN {
	...
	@EXPORT = qw(
		...
		AV_A_DIGEST_MD5_NONCE
		AV_A_DIGEST_MD5_RSPAUTH
		AV_A_DIGEST_MD5_URI
		AV_A_DIGEST_MD5_USER
		AV_A_EMAIL
		AV_A_FTP_ANONYMOUS
		AV_A_GID
		AV_A_GIDS
...
use constant AV_A_ARRAYSIZE => 55;
